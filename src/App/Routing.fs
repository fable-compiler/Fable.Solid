...
let Home () =
    JSX.jsx $"""
    <>
        <p> A collection of Fable bindings for SolidJS</p>
        <p> This is a demo of the bindings in use</p>
        <p> Click on the tabs above to see the different components</p>
        <p> The source code is available at <a href="https://github.com/fable-compiler/Fable.Solid">Fable.Solid</a></p>
    </>
    """
    ...
    JSX.jsx $"""
        ...
        <div style = { {| margin = "0 auto"; ``max-width`` = "800px"; padding = "20px" |} }>
            <ProvideColor color="green">
                <HashRouter root={{Tabs}} preload={false}>
